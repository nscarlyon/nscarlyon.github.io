...
*Please keep in mind that I encapsulated my code a bit more than what is presented here. The code snippets displayed in this post were modified for instructional purposes.*
