...
First, I needed to include a handlebars template in my recipe show view (Github blog interface does not like having {{}} surrounding text in the blog, so everything wrapped around * should be replaced with a curly brace '{' ):
